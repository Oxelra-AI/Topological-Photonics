...
reproduced without prior written permission.\\[6pt]
\textit{Submission draft --- not for distribution.}\\[6pt]
...
\input{chapters/ch11_reciprocal_designs}

\chapter{Valleys and Lattices}
\label{ch:valleys}
\input{chapters/ch12_valleys}

\chapter{Floquet Light}
\label{ch:floquet}
\input{chapters/ch13_floquet}

\chapter{One Dimension}
\label{ch:one-dimension}
\input{chapters/ch14_one_dimension}
...
\input{chapters/ch15_weyl_points}

\chapter{Synthetic Dimensions}
\label{ch:synthetic-dimensions}
\input{chapters/ch16_synthetic_dimensions}
...
\input{chapters/ch17_non_hermitian}

\chapter{Nonlinear and Quantum Frontiers}
\label{ch:nonlinear-quantum}
\input{chapters/ch18_nonlinear_quantum}
